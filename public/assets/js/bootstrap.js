    ...
    var t, e = {
        980: (t,e,i)=>{
            ...
            const J = {
                ...
                phase: "main",
                fn: function(t) {
                    var e, i = t.state, a = t.name, c = t.options, h = i.elements.arrow, d = i.modifiersData.popperOffsets, u = P(i.placement), f = X(u), p = [r, o].indexOf(u) >= 0 ? "height" : "width";
                    if (h && d) {
                        var g = function(t, e) {
            ...
            function et(t) {
                var e, i = t.popper, a = t.popperRect, l = t.placement, c = t.variation, d = t.offsets, u = t.position, f = t.gpuAcceleration, p = t.adaptive, g = t.roundOffsets, m = t.isFixed, _ = d.x, b = void 0 === _ ? 0 : _, v = d.y, y = void 0 === v ? 0 : v, w = "function" == typeof g ? g({
                    x: b,
                    y
                }) : {
                    x: b,
            ...
            function gt(t, e, i) {
                return e === u ? pt(function(t, e) {
                    ...
                    var e, i = R(t), n = ct(t), s = null == (e = t.ownerDocument) ? void 0 : e.body, o = N(i.scrollWidth, i.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), r = N(i.scrollHeight, i.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), a = -n.scrollLeft + ht(t), l = -n.scrollTop;
            ...
            function _t(t) {
                var e, i = t.reference, a = t.element, l = t.placement, d = l ? P(l) : null, u = l ? Z(l) : null, f = i.x + i.width / 2 - a.width / 2, p = i.y + i.height / 2 - a.height / 2;
                switch (d) {
                case n:
                    e = {
                        x: f,
            ...
            const Ct = {
                ...
                fn: function(t) {
                    ...
                    if (x) {
                        if (h) {
                            var H, $ = "y" === C ? n : r, W = "y" === C ? s : o, F = "y" === C ? "height" : "width", z = x[C], q = z + w[$], R = z - w[W], V = b ? -L[F] / 2 : 0, K = E === c ? k[F] : L[F], U = E === c ? -L[F] : -k[F], G = e.elements.arrow, J = b && G ? B(G) : {
                                width: 0,
                                height: 0
                                ...
                                bottom: 0,
                                left: 0
                            }, et = tt[$], it = tt[W], nt = Y(0, k[F], J[F]), st = T ? k[F] / 2 - V - nt - et - S.mainAxis : K - nt - et - S.mainAxis, ot = T ? -k[F] / 2 + V + nt + it + S.mainAxis : U + nt + it + S.mainAxis, rt = e.elements.arrow && Q(e.elements.arrow), at = rt ? "y" === C ? rt.clientTop || 0 : rt.clientLeft || 0 : 0, lt = null != (H = null == I ? void 0 : I[C]) ? H : 0, ct = z + ot - lt, ht = Y(b ? j(q, z + st - lt - at) : q, z, b ? N(R, ct) : R);
                            x[C] = ht,
                            M[C] = ht - z
                        }
                        if (u) {
                            var dt, ut = "x" === C ? n : r, ft = "x" === C ? s : o, pt = x[O], gt = "y" === O ? "height" : "width", mt = pt + w[ut], _t = pt - w[ft], vt = -1 !== [n, r].indexOf(A), yt = null != (dt = null == I ? void 0 : I[O]) ? dt : 0, wt = vt ? mt : pt - k[gt] - L[gt] - yt + S.altAxis, At = vt ? pt + k[gt] + L[gt] - yt - S.altAxis : _t, Et = b && vt ? function(t, e, i) {
                                var n = Y(t, e, i);
                                return n > i ? i : n
