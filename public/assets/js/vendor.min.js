!function(t, e) {
    ...
    var s, a = "alert", l = "bs.alert", h = "." + l, c = p.fn[a], d = {
        CLOSE: "close" + h,
        CLOSED: "closed" + h,
    ...
    ;
    var v, _ = "button", y = "bs.button", w = "." + y, b = ".data-api", C = p.fn[_], E = "active", x = '[data-toggle^="button"]', T = 'input:not([type="hidden"])', S = ".btn", A = {
        CLICK_DATA_API: "click" + w + b,
        FOCUS_BLUR_DATA_API: "focus" + w + b + " blur" + w + b,
        LOAD_DATA_API: "load" + w + b
    }, I = ((v = k.prototype).toggle = function() {
        var t = !0
          , e = !0
        ...
        if (i) {
            ...
            if (n) {
                if ("radio" === n.type)
                    if (n.checked && this._element.classList.contains(E))
                        t = !1;
                    else {
                    ...
                    ("checkbox" !== n.type || "LABEL" === this._element.tagName && n.checked === this._element.classList.contains(E)) && (t = !1);
                t && (n.checked = !this._element.classList.contains(E),
                p(n).trigger("change")),
                n.focus(),
                e = !1
            }
        }
        this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (e && this._element.setAttribute("aria-pressed", !this._element.classList.contains(E)),
        t && p(this._element).toggleClass(E))
    }
    ,
    v.dispose = function() {
    ...
    p(document).on(A.CLICK_DATA_API, x, function(t) {
        var e = t.target;
        if (p(e).hasClass("btn") || (e = p(e).closest(S)[0]),
    ...
    p.fn[_] = I._jQueryInterface,
    p.fn[_].Constructor = I,
    p.fn[_].noConflict = function() {
        return p.fn[_] = C,
        I._jQueryInterface
    }
    ;
    var D, O = "carousel", N = "bs.carousel", P = "." + N, L = ".data-api", j = p.fn[O], z = {
        interval: 5e3,
        keyboard: !0,
        slide: !1,
        pause: "hover",
    ...
    }, W = "active", q = ".active.carousel-item", $ = {
        TOUCH: "touch",
        PEN: "pen"
    ...
    D.to = function(t) {
        ...
        if (!(t > this._items.length - 1 || t < 0))
            if (this._isSliding)
                p(this._element).one(F.SLID, function() {
                    return e.to(t)
                });
            else {
                if (i === t)
    ...
    D._addTouchEventListeners = function() {
        ...
        if (this._touchSupported) {
            var e = function(t) {
                i._pointerEvent && $[t.originalEvent.pointerType.toUpperCase()] ? i.touchStartX = t.originalEvent.clientX : i._pointerEvent || (i.touchStartX = t.originalEvent.touches[0].clientX)
            }
              , n = function(t) {
                i._pointerEvent && $[t.originalEvent.pointerType.toUpperCase()] && (i.touchDeltaX = t.originalEvent.clientX - i.touchStartX),
                i._handleSwipe(),
    ...
    D._triggerSlideEvent = function(t, e) {
        ...
        return p(this._element).trigger(s),
        s
    }
    ,
    ...
    D._slide = function(t, e) {
        var i, n, s, o = this, r = this._element.querySelector(q), a = this._getItemIndex(r), l = e || r && this._getItemByDirection(t, r), h = this._getItemIndex(l), c = Boolean(this._interval);
        if (s = t === M ? (i = "carousel-item-left",
        ...
        l && p(l).hasClass(W))
            ...
            if (p(this._element).hasClass("slide")) {
                ...
                p(r).one(m.TRANSITION_END, function() {
                    p(l).removeClass(i + " " + n).addClass(W),
                    p(r).removeClass(W + " " + n + " " + i),
                    o._isSliding = !1,
                    setTimeout(function() {
    ...
    p(document).on(F.CLICK_DATA_API, "[data-slide], [data-slide-to]", B._dataApiClickHandler),
    p(window).on(F.LOAD_DATA_API, function() {
        for (var t = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), e = 0, i = t.length; e < i; e++) {
            var n = p(t[e]);
            B._jQueryInterface.call(n, n.data())
        }
    }),
    p.fn[O] = B._jQueryInterface,
    p.fn[O].Constructor = B,
    p.fn[O].noConflict = function() {
        return p.fn[O] = j,
        B._jQueryInterface
    }
    ;
    var Q, K = "collapse", V = "bs.collapse", Y = "." + V, Z = p.fn[K], X = {
        toggle: !0,
        parent: ""
    }, G = {
        toggle: "boolean",
    ...
    }, tt = "show", et = "collapse", it = "collapsing", nt = "collapsed", st = '[data-toggle="collapse"]', ot = ((Q = rt.prototype).toggle = function() {
    ...
    Q.show = function() {
        ...
        t && (e = p(t).not(this._selector).data(V)) && e._isTransitioning))) {
            var n = p.Event(J.SHOW);
            if (p(this._element).trigger(n),
            !n.isDefaultPrevented()) {
                t && (rt._jQueryInterface.call(p(t).not(this._selector), "hide"),
                e || p(t).data(V, null));
                var s = this._getDimension();
                p(this._element).removeClass(et).addClass(it),
                this._element.style[s] = 0,
                this._triggerArray.length && p(this._triggerArray).removeClass(nt).attr("aria-expanded", !0),
                this.setTransitioning(!0);
                var o = "scroll" + (s[0].toUpperCase() + s.slice(1))
                  , r = m.getTransitionDurationFromElement(this._element);
                p(this._element).one(m.TRANSITION_END, function() {
                    p(i._element).removeClass(it).addClass(et).addClass(tt),
                    i._element.style[s] = "",
                    i.setTransitioning(!1),
                    p(i._element).trigger(J.SHOWN)
    ...
    Q.hide = function() {
        ...
        if (!this._isTransitioning && p(this._element).hasClass(tt)) {
            ...
            !e.isDefaultPrevented()) {
                ...
                p(this._element).addClass(it).removeClass(et).removeClass(tt);
                ...
                p(this._element).one(m.TRANSITION_END, function() {
                    ...
                    p(t._element).removeClass(it).addClass(et).trigger(J.HIDDEN)
    ...
    Q._getConfig = function(t) {
        return (t = r({}, X, {}, t)).toggle = Boolean(t.toggle),
        m.typeCheckConfig(K, t, G),
        t
    }
    ,
    ...
    p.fn[K] = ot._jQueryInterface,
    p.fn[K].Constructor = ot,
    p.fn[K].noConflict = function() {
        return p.fn[K] = Z,
        ot._jQueryInterface
    }
    ;
    var at, lt = "dropdown", ht = "bs.dropdown", ct = "." + ht, ut = ".data-api", dt = p.fn[lt], ft = new RegExp("38|40|27"), pt = {
        HIDE: "hide" + ct,
        HIDDEN: "hidden" + ct,
        SHOW: "show" + ct,
        SHOWN: "shown" + ct,
    ...
    }, mt = "disabled", gt = "show", vt = "dropdown-menu-right", _t = '[data-toggle="dropdown"]', yt = ".dropdown-menu", wt = {
        offset: 0,
        flip: !0,
    ...
    at.show = function(t) {
        if (void 0 === t && (t = !1),
        !(this._element.disabled || p(this._element).hasClass(mt) || p(this._menu).hasClass(gt))) {
            var e = {
            ...
            !i.isDefaultPrevented()) {
                if (!this._inNavbar && t) {
                    ...
                    var s = this._element;
                    "parent" === this._config.reference ? s = n : m.isElement(this._config.reference) && (s = this._config.reference,
                ...
                p(this._menu).toggleClass(gt),
                p(n).toggleClass(gt).trigger(p.Event(pt.SHOWN, e))
            }
        }
    }
    ,
    at.hide = function() {
        if (!this._element.disabled && !p(this._element).hasClass(mt) && p(this._menu).hasClass(gt)) {
            ...
            p(this._menu).toggleClass(gt),
            p(i).toggleClass(gt).trigger(p.Event(pt.HIDDEN, t)))
        }
    }
    ,
    at.dispose = function() {
        p.removeData(this._element, ht),
        p(this._element).off(ct),
        this._element = null,
    ...
    at._getConfig = function(t) {
        return t = r({}, this.constructor.Default, {}, p(this._element).data(), {}, t),
        m.typeCheckConfig(lt, t, this.constructor.DefaultType),
        t
    }
    ,
    ...
    at._getPlacement = function() {
        ...
        p(this._menu).hasClass(vt) && (e = "top-end")) : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : p(this._menu).hasClass(vt) && (e = "bottom-end"),
        e
    }
    ,
    ...
    Et._jQueryInterface = function(e) {
        return this.each(function() {
            ...
            if (t || (t = new Et(this,"object" == typeof e ? e : null),
            p(this).data(ht, t)),
            "string" == typeof e) {
                if (void 0 === t[e])
            ...
            for (var e = [].slice.call(document.querySelectorAll(_t)), i = 0, n = e.length; i < n; i++) {
                ...
                o) {
                    ...
                    if (p(s).hasClass(gt) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && p.contains(s, t.target))) {
                        ...
                        p(a).removeClass(gt),
                        p(s).removeClass(gt).trigger(p.Event(pt.HIDDEN, r)))
                    }
                }
            }
    }
    ...
    Et._dataApiKeydownHandler = function(t) {
        if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || p(t.target).closest(yt).length)) : ft.test(t.which)) && (t.preventDefault(),
        t.stopPropagation(),
        !this.disabled && !p(this).hasClass(mt))) {
    ...
    ;
    var xt, Tt = "modal", St = "bs.modal", At = "." + St, It = p.fn[Tt], kt = {
        backdrop: !0,
        keyboard: !0,
        focus: !0,
        show: !0
        ...
        HIDE: "hide" + At,
        HIDE_PREVENTED: "hidePrevented" + At,
        HIDDEN: "hidden" + At,
        SHOW: "show" + At,
        SHOWN: "shown" + At,
        FOCUSIN: "focusin" + At,
    ...
    }, Nt = "modal-open", Pt = "fade", Lt = "show", jt = "modal-static", zt = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", Ht = ".sticky-top", Mt = ((xt = Rt.prototype).toggle = function(t) {
    ...
    xt.show = function(t) {
        ...
        if (!this._isShown && !this._isTransitioning) {
            ...
            p(this._element).on(Ot.CLICK_DISMISS, '[data-dismiss="modal"]', function(t) {
                return e.hide(t)
            }),
    ...
    xt.hide = function(t) {
        ...
        this._isShown && !this._isTransitioning) {
            ...
            this._isShown && !i.isDefaultPrevented()) {
                ...
                p(this._element).removeClass(Lt),
    ...
    xt._hideModal = function() {
        ...
        this._isTransitioning = !1,
        this._showBackdrop(function() {
            p(document.body).removeClass(Nt),
            t._resetAdjustments(),
            t._resetScrollbar(),
            p(t._element).trigger(Ot.HIDDEN)
        })
    }
    ,
    ...
    xt._showBackdrop = function(t) {
        ...
        if (this._isShown && this._config.backdrop) {
            ...
            p(this._element).on(Ot.CLICK_DISMISS, function(t) {
                e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && e._triggerBackdropTransition()
            }),
            i && m.reflow(this._backdrop),
            p(this._backdrop).addClass(Lt),
            !t)
                return;
            if (!i)
                return void t();
    ...
    p.fn[Tt] = Mt._jQueryInterface,
    p.fn[Tt].Constructor = Mt,
        ...
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), r = Object.keys(o), a = [].slice.call(i.body.querySelectorAll("*")), n = function(t) {
            ...
            n.forEach(function(t) {
                !function(t, e) {
                    ...
                    if (-1 !== e.indexOf(i))
                        return -1 === Ft.indexOf(i) || Boolean(t.nodeValue.match(Wt) || t.nodeValue.match(qt));
    ...
    var Bt, Ut = "tooltip", Qt = "bs.tooltip", Kt = "." + Qt, Vt = p.fn[Ut], Yt = "bs-tooltip", Zt = new RegExp("(^|\\s)" + Yt + "\\S+","g"), Xt = ["sanitize", "whiteList", "sanitizeFn"], Gt = {
        animation: "boolean",
        template: "string",
    ...
    }, ne = "fade", se = "show", oe = "hover", re = "focus", ae = ((Bt = le.prototype).enable = function() {
        this._isEnabled = !0
    }
    ,
    Bt.disable = function() {
    ...
    Bt.toggle = function(t) {
        if (this._isEnabled)
            if (t) {
                ...
                if (p(this.getTipElement()).hasClass(se))
    ...
    Bt.show = function() {
        ...
        if (this.isWithContent() && this._isEnabled) {
            ...
            this.setContent(),
            this.config.animation && p(s).addClass(ne);
            var r = "function" == typeof this.config.placement ? this.config.placement.call(this, s, this.element) : this.config.placement
              , a = this._getAttachment(r);
            this.addAttachmentClass(a);
            var l = this._getContainer();
            p(s).data(this.constructor.DATA_KEY, this),
            p.contains(this.element.ownerDocument.documentElement, this.tip) || p(s).appendTo(l),
    ...
    Bt.hide = function(t) {
        function e() {
            i._hoverState !== ee && n.parentNode && n.parentNode.removeChild(n),
            i._cleanTipClass(),
        ...
        if (p(this.element).trigger(s),
        !s.isDefaultPrevented()) {
            if (p(n).removeClass(se),
    ...
    Bt.setContent = function() {
        ...
        p(t).removeClass(ne + " " + se)
    }
    ,
    Bt.setElementContent = function(t, e) {
        "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = $t(e, this.config.whiteList, this.config.sanitizeFn)),
    ...
    Bt._enter = function(t, e) {
        ...
        t && (e._activeTrigger["focusin" === t.type ? re : oe] = !0),
        p(e.getTipElement()).hasClass(se) || e._hoverState === ee ? e._hoverState = ee : (clearTimeout(e._timeout),
        e._hoverState = ee,
    ...
    Bt._leave = function(t, e) {
        ...
        (e = e || p(t.currentTarget).data(i)) || (e = new this.constructor(t.currentTarget,this._getDelegateConfig()),
        p(t.currentTarget).data(i, e)),
        t && (e._activeTrigger["focusout" === t.type ? re : oe] = !1),
    ...
    Bt._getConfig = function(t) {
        ...
        m.typeCheckConfig(Ut, t, this.constructor.DefaultType),
    ...
    Bt._fixTransition = function() {
        ...
        null === t.getAttribute("x-placement") && (p(t).removeClass(ne),
    ...
    le._jQueryInterface = function(i) {
        return this.each(function() {
            var t = p(this).data(Qt)
              , e = "object" == typeof i && i;
            if ((t || !/dispose|hide/.test(i)) && (t || (t = new le(this,e),
            p(this).data(Qt, t)),
            "string" == typeof i)) {
                if (void 0 === t[i])
                    throw new TypeError('No method named "' + i + '"');
    ...
    p.fn[Ut] = ae._jQueryInterface,
    p.fn[Ut].Constructor = ae,
    ...
    p.fn[he] = _e._jQueryInterface,
    p.fn[he].Constructor = _e,
    p.fn[he].noConflict = function() {
        return p.fn[he] = de,
        _e._jQueryInterface
    }
    ;
    var ye, we = "scrollspy", be = "bs.scrollspy", Ce = "." + be, Ee = p.fn[we], xe = {
        offset: 10,
        method: "auto",
        target: ""
    }, Te = {
    ...
    }, Ae = "active", Ie = ".nav, .list-group", ke = ".nav-link", De = ".list-group-item", Oe = "position", Ne = ((ye = Pe.prototype).refresh = function() {
        var e = this
    ...
    ye._getConfig = function(t) {
        ...
        return m.typeCheckConfig(we, t, Te),
        t
    }
    ,
    ...
    ye._activate = function(e) {
        ...
        i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(Ae),
        i.addClass(Ae)) : (i.addClass(Ae),
        i.parents(Ie).prev(ke + ", " + De).addClass(Ae),
        i.parents(Ie).prev(".nav-item").children(ke).addClass(Ae)),
        p(this._scrollElement).trigger(Se.ACTIVATE, {
            relatedTarget: e
        })
    }
    ,
    ...
    Pe._jQueryInterface = function(e) {
        return this.each(function() {
            ...
            if (t || (t = new Pe(this,"object" == typeof e && e),
            p(this).data(be, t)),
            "string" == typeof e) {
                if (void 0 === t[e])
                    throw new TypeError('No method named "' + e + '"');
    ...
    function Pe(t, e) {
        ...
        this._config = this._getConfig(e),
        this._selector = this._config.target + " " + ke + "," + this._config.target + " " + De + "," + this._config.target + " .dropdown-item",
        this._offsets = [],
        this._targets = [],
        this._activeTarget = null,
        this._scrollHeight = 0,
        p(this._scrollElement).on(Se.SCROLL, function(t) {
            return i._process(t)
        }),
        this.refresh(),
        this._process()
    ...
    p.fn[we] = Ne._jQueryInterface,
    p.fn[we].Constructor = Ne,
    p.fn[we].noConflict = function() {
        return p.fn[we] = Ee,
        Ne._jQueryInterface
    }
    ;
    var Le, je = "bs.tab", ze = "." + je, He = p.fn.tab, Me = {
        HIDE: "hide" + ze,
        HIDDEN: "hidden" + ze,
        SHOW: "show" + ze,
        SHOWN: "shown" + ze,
        CLICK_DATA_API: "click" + ze + ".data-api"
    }, Re = "active", Fe = ".active", We = "> li > .active", qe = ((Le = $e.prototype).show = function() {
        var i = this;
        if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Re) || p(this._element).hasClass("disabled"))) {
            var t, n, e = p(this._element).closest(".nav, .list-group")[0], s = m.getSelectorFromElement(this._element);
            if (e) {
    ...
    p(document).on(Me.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(),
        qe._jQueryInterface.call(p(this), "show")
    }),
    p.fn.tab = qe._jQueryInterface,
    p.fn.tab.Constructor = qe,
    p.fn.tab.noConflict = function() {
        return p.fn.tab = He,
        qe._jQueryInterface
    }
    ;
    var Be, Ue = "toast", Qe = "bs.toast", Ke = "." + Qe, Ve = p.fn[Ue], Ye = {
        CLICK_DISMISS: "click.dismiss" + Ke,
        HIDE: "hide" + Ke,
        HIDDEN: "hidden" + Ke,
        SHOW: "show" + Ke,
        SHOWN: "shown" + Ke
    }, Ze = "show", Xe = "showing", Ge = {
        animation: "boolean",
        autohide: "boolean",
        delay: "number"
    }, Je = {
    ...
    Be.dispose = function() {
        ...
        p(this._element).off(Ye.CLICK_DISMISS),
        p.removeData(this._element, Qe),
        this._element = null,
        this._config = null
    }
    ,
    Be._getConfig = function(t) {
        return t = r({}, Je, {}, p(this._element).data(), {}, "object" == typeof t && t ? t : {}),
        m.typeCheckConfig(Ue, t, this.constructor.DefaultType),
        t
    }
    ,
    ...
    Be._close = function() {
        function t() {
            ...
            p(e._element).trigger(Ye.HIDDEN)
        }
        var e = this;
    ...
    ei._jQueryInterface = function(i) {
        return this.each(function() {
            var t = p(this)
              , e = t.data(Qe);
            if (e || (e = new ei(this,"object" == typeof i && i),
            t.data(Qe, e)),
            "string" == typeof i) {
                if (void 0 === e[i])
                    throw new TypeError('No method named "' + i + '"');
    ...
    p.fn[Ue] = ti._jQueryInterface,
    p.fn[Ue].Constructor = ti,
            ...
            s.submit(function() {
                ...
                h.ajax({
                    ...
                    success: function(e) {
                        ...
                        "en" !== a.language && void 0 !== h.ajaxChimp.responses[n] && h.ajaxChimp.translations && h.ajaxChimp.translations[a.language] && h.ajaxChimp.translations[a.language][h.ajaxChimp.responses[n]] && (n = h.ajaxChimp.translations[a.language][h.ajaxChimp.responses[n]]),
                        r.html(n),
                        r.show(2e3),
                ...
                var e = "Submitting...";
                return "en" !== a.language && h.ajaxChimp.translations && h.ajaxChimp.translations[a.language] && h.ajaxChimp.translations[a.language].submit && (e = h.ajaxChimp.translations[a.language].submit),
                r.html(e).show(2e3),
                !1
            })
        }),
        ...
        return this.each(function() {
            ...
            l.waypoint(function() {
                ...
                for (var s = /^[0-9]+\.[0-9]+$/.test(i), o = s ? (i.split(".")[1] || []).length : 0, r = e; 1 <= r; r--) {
                    ...
                    if (s && (a = parseFloat(i / e * r).toFixed(o)),
                    n)
...
function(t) {
    ...
    function d(t, e, i, n) {
        ...
        i && (s.innerHTML = i),
        n ? e && e.appendChild(s) : (s = c(s),
        e && s.appendTo(e)),
        s
    }
    function f(t, e) {
        m.ev.triggerHandler("mfp" + t, e),
        m.st.callbacks && (t = t.charAt(0).toLowerCase() + t.slice(1),
        m.st.callbacks[t] && m.st.callbacks[t].apply(m, c.isArray(e) ? e : [e]))
    }
    function p(t) {
        return t === e && m.currTemplate.closeBtn || (m.currTemplate.closeBtn = c(m.st.closeMarkup.replace("%title%", m.st.tClose)),
        e = t),
        m.currTemplate.closeBtn
    }
    function o() {
        c.magnificPopup.instance || ((m = new t).init(),
        c.magnificPopup.instance = m)
    }
    var m, n, g, s, v, e, l = "Close", h = "BeforeClose", _ = "MarkupParse", y = "Open", w = ".mfp", b = "mfp-ready", i = "mfp-removing", r = "mfp-prevent-close", a = !!window.jQuery, C = c(window);
    t.prototype = {
        constructor: t,
        init: function() {
        ...
        open: function(t) {
            ...
            if (!1 === t.isObj) {
                ...
                m.items = c.isArray(t.items) ? t.items : [t.items],
                m.index = t.index || 0;
            if (!m.isOpen) {
                m.types = [],
                v = "",
                t.mainEl && t.mainEl.length ? m.ev = t.mainEl.eq(0) : m.ev = g,
                t.key ? (m.popupsCache[t.key] || (m.popupsCache[t.key] = {}),
                m.currTemplate = m.popupsCache[t.key]) : m.currTemplate = {},
                ...
                m.bgOverlay || (m.bgOverlay = d("bg").on("click" + w, function() {
                    m.close()
                }),
                ...
                f("BeforeOpen"),
                m.st.showCloseBtn && (m.st.closeBtnInside ? (u(_, function(t, e, i, n) {
                    i.close_replaceWith = p(n.type)
                }),
                v += " mfp-close-btn-in") : m.wrap.append(p())),
                ...
                setTimeout(function() {
                    m.content ? (m._addClassToMFP(b),
                    m._setFocus()) : m.bgOverlay.addClass(b),
        ...
        close: function() {
            m.isOpen && (f(h),
            m.isOpen = !1,
            m.st.removalDelay && !m.isLowIE && m.supportsTransition ? (m._addClassToMFP(i),
            setTimeout(function() {
                m._close()
        ...
        updateItemHTML: function() {
            ...
            var e = t.type;
            if (f("BeforeChange", [m.currItem ? m.currItem.type : "", e]),
            m.currItem = t,
            !m.currTemplate[e]) {
                var i = !!m.st[e] && m.st[e].markup;
                f("FirstMarkupParse", i),
                m.currTemplate[e] = !i || c(i)
            }
        ...
        appendContent: function(t, e) {
            (m.content = t) ? m.st.showCloseBtn && m.st.closeBtnInside && !0 === m.currTemplate[e] ? m.content.find(".mfp-close").length || m.content.append(p()) : m.content = t : m.content = "",
            f("BeforeAppend"),
        ...
        _checkIfClose: function(t) {
            if (!c(t).hasClass(r)) {
                ...
                if (e && i)
                    return !0;
                if (!m.content || c(t).hasClass("mfp-close") || m.preloader && t === m.preloader[0])
                    return !0;
        ...
        _onFocusIn: function(t) {
            return t.target === m.wrap[0] || c.contains(m.wrap[0], t.target) ? void 0 : (m._setFocus(),
            !1)
        },
            ...
            getInline: function(t, e) {
                ...
                t.src) {
                    ...
                    if (n.length) {
                        ...
                        s && s.tagName && (T || (x = i.hiddenClass,
                        T = d(x),
                        x = "mfp-" + x),
                        S = n.after(T).detach().removeClass(x)),
                        m.updateStatus("ready")
                    } else
                        m.updateStatus("error", i.tNotFound),
                        n = c("<div>");
    ...
    c.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            _onImageHasSize: function(t) {
                ...
                f("ImageHasSize", t),
                t.imgHidden && (m.content && m.content.removeClass("mfp-loading"),
                t.imgHidden = !1))
            },
                ...
                var i = 0
                  ...
                  , s = function(t) {
                    ...
                    N = setInterval(function() {
                        return 0 < n.naturalWidth ? void m._onImageHasSize(e) : (200 < i && clearInterval(N),
            ...
            getImage: function(t, e) {
                var i = 0
                  , n = function() {
                    ...
                    t === m.currItem && (m._onImageHasSize(t),
                    m.updateStatus("ready")),
                    t.hasSize = !0,
                    t.loaded = !0,
                    f("ImageLoadComplete")) : ++i < 200 ? setTimeout(n, 100) : s())
                }
                  , s = function() {
                ...
                if (r.length) {
                    ...
                    t.img = c(a).on("load.mfploader", n).on("error.mfploader", s),
                    a.src = t.src,
                ...
                m.resizeImage(),
                t.hasSize ? (N && clearInterval(N),
                t.loadError ? (e.addClass("mfp-loading"),
                m.updateStatus("error", o.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"),
    ...
    c.magnificPopup.registerModule("zoom", {
        ...
        proto: {
                ...
                if (o.enabled && m.supportsTransition) {
                    function i(t) {
                        var e = t.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image")
                          ...
                          , s = "transition";
                        return n["-webkit-" + s] = n["-moz-" + s] = n["-o-" + s] = n[s] = i,
                        e.css(n),
                        e
                    }
                    function n() {
            ...
            _getOffset: function(t) {
                ...
                P ? o["-moz-transform"] = o.transform = "translate(" + i.left + "px," + i.top + "px)" : (o.left = i.left,
                o.top = i.top),
                o
            }
        }
    ...
    c.magnificPopup.registerModule(j, {
        ...
        proto: {
            ...
            getIframe: function(t, e) {
                ...
                var s = {};
                return n.srcAction && (s[n.srcAction] = i),
...
function(t) {
    ...
    var u, d, t = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"], e = "onwheel"in window.document || 9 <= window.document.documentMode ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"], f = Array.prototype.slice;
    if (c.event.fixHooks)
    ...
    function n(t) {
        var e, i = t || window.event, n = f.call(arguments, 1), s = 0, o = 0, r = 0;
        if ((t = c.event.fix(i)).type = "mousewheel",
        "detail"in i && (r = -1 * i.detail),
        "wheelDelta"in i && (r = i.wheelDelta),
        "wheelDeltaY"in i && (r = i.wheelDeltaY),
        "wheelDeltaX"in i && (o = -1 * i.wheelDeltaX),
        "axis"in i && i.axis === i.HORIZONTAL_AXIS && (o = -1 * r,
        r = 0),
        s = 0 === r ? o : r,
        "deltaY"in i && (s = r = -1 * i.deltaY),
        "deltaX"in i && (o = i.deltaX,
        0 === r && (s = -1 * o)),
        0 !== r || 0 !== o) {
            if (1 === i.deltaMode) {
            ...
            if (e = Math.max(Math.abs(r), Math.abs(o)),
            (!d || e < d) && g(i, d = e) && (d /= 40),
            g(i, e) && (s /= 40,
            o /= 40,
            r /= 40),
            ...
            p.settings.normalizeOffset && this.getBoundingClientRect) {
                ...
                t.offsetX = t.clientX - h.left,
                t.offsetY = t.clientY - h.top
            }
            return t.deltaX = o,
            t.deltaY = r,
            t.deltaFactor = d,
...
function(t) {
    ...
    c.extend(c.fn, {
        ...
        rules: function(t, e) {
            var i, n, s, o, r, a, l = this[0], h = void 0 !== this.attr("contenteditable") && "false" !== this.attr("contenteditable");
            if (null != l && (!l.form && h && (l.form = this.closest("form")[0],
            ...
            null != l.form)) {
                ...
                return (o = c.validator.normalizeRules(c.extend({}, c.validator.classRules(l), c.validator.attributeRules(l), c.validator.dataRules(l), c.validator.staticRules(l)), l)).required && (r = o.required,
                delete o.required,
                o = c.extend({
                    required: r
                }, o)),
    ...
    c.extend(c.validator, {
        ...
        prototype: {
            init: function() {
                function t(t) {
                    ...
                    if (!this.form && e && (this.form = c(this).closest("form")[0],
            ...
            element: function(t) {
                ...
                (i = this.groups[s.name]) && c.each(this.groups, function(t, e) {
            ...
            elements: function() {
                ...
                return c(this.currentForm).find("input, select, textarea, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function() {
                    ...
                    this.name = t),
                    !(this.form !== i.currentForm || t in n || !i.objectLength(c(this).rules()) || (n[t] = !0,
                    0))
                })
            },
            clean: function(t) {
            ...
            elementValue: function(t) {
                var e, i, n = c(t), s = t.type, o = void 0 !== n.attr("contenteditable") && "false" !== n.attr("contenteditable");
                return "radio" === s || "checkbox" === s ? this.findByName(t.name).filter(":checked").val() : "number" === s && void 0 !== t.validity ? t.validity.badInput ? "NaN" : n.val() : (e = o ? n.text() : n.val(),
                "file" === s ? "C:\\fakepath\\" === e.substr(0, 12) ? e.substr(12) : 0 <= (i = e.lastIndexOf("/")) ? e.substr(i + 1) : 0 <= (i = e.lastIndexOf("\\")) ? e.substr(i + 1) : e : "string" == typeof e ? e.replace(/\r/g, "") : e)
            },
            check: function(e) {
                ...
                for (i in "function" == typeof o.normalizer ? s = o.normalizer : "function" == typeof this.settings.normalizer && (s = this.settings.normalizer),
                s && (l = s.call(e, l),
                delete o.normalizer),
                o) {
                    n = {
            ...
            showLabel: function(t, e) {
                ...
                r.html(e)) : (i = r = c("<" + this.settings.errorElement + ">").attr("id", a + "-error").addClass(this.settings.errorClass).html(e || ""),
        ...
        dataRules: function(t) {
            var e, i, n = {}, s = c(t), o = t.getAttribute("type");
            for (e in c.validator.methods)
                "" === (i = s.data("rule" + e.charAt(0).toUpperCase() + e.substring(1).toLowerCase())) && (i = !0),
                this.normalizeAttributeRule(n, o, e, i);
            return n
        },
            ...
            return c.each(n, function(t, e) {
                if (!1 !== e) {
                    if (e.param || e.depends) {
                        ...
                        i ? n[t] = void 0 === e.param || e.param : (c.data(s.form, "validator").resetElements(c(s)),
                        delete n[t])
                    }
                } else
                    delete n[t]
        ...
        methods: {
            ...
            step: function(t, e, i) {
                ...
                var o, r = c(e).attr("type"), a = "Step attribute on input type " + r + " is not supported.", l = new RegExp("\\b" + r + "\\b"), h = !0;
            ...
            remote: function(o, r, t, a) {
                ...
                h.originalMessage = h.originalMessage || this.settings.messages[r.name][a],
                this.settings.messages[r.name][a] = h.message,
                t = "string" == typeof t ? {
                    url: t
                } : t,
                i = c.param(c.extend({
                ...
                c.ajax(c.extend(!0, {
                    ...
                    success: function(t) {
                        ...
                        l.settings.messages[r.name][a] = h.originalMessage,
                        s ? (n = l.formSubmitted,
                        l.resetInternals(),
                        ...
                        l.invalid[r.name] = !1,
                        l.showErrors()) : (e = {},
                        i = t || l.defaultMessage(r, {
                            method: a,
                            parameters: o
                        }),
                        e[r.name] = h.message = i,
                        l.invalid[r.name] = !0,
                        l.showErrors(e)),
                        h.valid = s,
                        l.stopRequest(r, s)
    ...
    i.prototype.refresh = function() {
        ...
        t = {
            ...
            for (var r in this.waypoints[s]) {
                var a, l, h, c, u = this.waypoints[s][r], d = u.options.offset, f = u.triggerPoint, p = 0, m = null == f;
                u.element !== u.element.window && (p = u.adapter.offset()[o.offsetProp]),
                "function" == typeof d ? d = d.apply(u) : "string" == typeof d && (d = parseFloat(d),
                -1 < u.options.offset.indexOf("%") && (d = Math.ceil(o.contextDimension * d / 100))),
                a = o.contextScroll - o.contextOffset,
                u.triggerPoint = Math.floor(p + a - d),
                l = f < o.oldScroll,
                h = u.triggerPoint >= o.oldScroll,
                c = !l && !h,
                !m && (l && h) ? (u.queueTrigger(o.backward),
                n[u.group.id] = u.group) : (!m && c || m && o.oldScroll >= u.triggerPoint) && (u.queueTrigger(o.forward),
...
function(l, i, s, a) {
    ...
    h.prototype.closest = function(i, n) {
        ...
        return this.settings.freeDrag || l.each(r, l.proxy(function(t, e) {
            return "left" === n && e - 30 < i && i < e + 30 ? s = t : "right" === n && e - o - 30 < i && i < e - o + 30 ? s = t + 1 : this.op(i, "<", e) && this.op(i, ">", r[t + 1] !== a ? r[t + 1] : e - o) && (s = "left" === n ? t + 1 : t),
            -1 === s
        }, this)),
    ...
    h.prototype.register = function(i) {
        if (i.type === h.Type.Event) {
            ...
            i.type === h.Type.State && (this._states.tags[i.name] ? this._states.tags[i.name] = this._states.tags[i.name].concat(i.tags) : this._states.tags[i.name] = i.tags,
...
function(c, e) {
    ...
    i.prototype.thumbnail = function(e, t) {
        ...
        var n, s, o = t.width && t.height ? "width:" + t.width + "px;height:" + t.height + "px;" : "", r = e.find("img"), a = "src", l = "", h = this._core.settings;
        if (e.wrap(c("<div/>", {
    ...
    i.prototype.play = function(t) {
        var e, i = c(t.target).closest("." + this._core.settings.itemClass), n = this._videos[i.attr("data-video")], s = n.width || "100%", o = n.height || this._core.$stage.height();
...
function(n, s, e) {
    ...
    i.prototype._next = function(t) {
        this._call = s.setTimeout(n.proxy(this._next, this, t), this._timeout * (Math.round(this.read() / this._timeout) + 1) - this.read()),
...
function(o) {
    ...
    e.prototype.draw = function() {
        ...
        e.nav && (this._controls.$previous.toggleClass("disabled", !s && n <= this._core.minimum(!0)),
...
function(s, o) {
    ...
    h() && (s.support.animation = new String(t("animation")),
    s.support.animation.end = i.animation.end[s.support.animation]),
    n() && (s.support.transform = new String(t("transform")),
...
function(t, e) {
    ...
    function C(t, e) {
        ...
        if (t !== l && e !== l || n.contains(s))
            return "BODY" === (a = (r = l).nodeName) || "HTML" !== a && b(r.firstElementChild) !== r ? b(l) : l;
        var h = c(t);
    ...
    function n(t, e, i, n) {
        return L(e["offset" + t], i["client" + t], i["offset" + t], $() ? i["offset" + t] + n["margin" + ("Height" === t ? "Top" : "Left")] + n["margin" + ("Height" === t ? "Bottom" : "Right")] : 0)
    }
    function x() {
    ...
    function f(t, e, i, n) {
        ...
        if ("viewport" === n)
            ...
            r = A(s, o),
            a = L(o.clientWidth, window.innerWidth || 0),
            l = L(o.clientHeight, window.innerHeight || 0),
            h = E(o),
            c = E(o, "left"),
            u = T({
    ...
    function O(t, i, e) {
        return (void 0 === e ? t : t.slice(0, function(t, e, i) {
            ...
            t.enabled && o(e) && (i.offsets.popper = T(i.offsets.popper),
    ...
    function h(i, n) {
        Object.keys(n).forEach(function(t) {
            var e = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && d(n[t]) && (e = "px"),
            i.style[t] = n[t] + e
        })
    }
    function m(t, e, i) {
            ...
            return t.reduce(function(t, e) {
                ...
                return function(t, e, i, n) {
                    ...
                    if (!r)
                        return t;
                    if (0 !== a.indexOf("%"))
                        return "vh" !== a && "vw" !== a ? r : ("vh" === a ? L(document.documentElement.clientHeight, window.innerHeight || 0) : L(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * r;
                    switch (a) {
                    case "%p":
                        s = i;
                        break;
    ...
    var F, W, q = j && (W = window.MutationObserver,
    r.some(function(t) {
    ...
    , $ = function() {
        return null == F && (F = -1 !== navigator.appVersion.indexOf("MSIE 10")),
        F
    }, B = function(t, e, i) {
    ...
    , Q = ["auto-start", "auto", "auto-end", "top-start", "top", "top-end", "right-start", "right", "right-end", "bottom-end", "bottom", "bottom-start", "left-end", "left", "left-start"], K = Q.slice(3), V = "flip", Y = "clockwise", Z = "counterclockwise", X = (B(G, [{
        key: "update",
        value: function() {
            return function() {
    ...
    function G(t, e) {
        ...
        Object.keys(U({}, G.Defaults.modifiers, n.modifiers)).forEach(function(t) {
    ...
    X.Defaults = {
        ...
        modifiers: {
                ...
                fn: function(t, n) {
                    ...
                    var i = n.priority
                      ...
                      , r = {
                        primary: function(t) {
                            var e = o[t];
                            return o[t] < s[t] && !n.escapeWithReference && (e = L(o[t], s[t])),
                            R({}, t, e)
                        },
                        secondary: function(t) {
                            var e = "right" === t ? "left" : "top"
                              , i = o[e];
                            return o[t] > s[t] && !n.escapeWithReference && (i = v(o[e], s[t] - ("right" === t ? o.width : o.height))),
                            R({}, e, i)
                        }
                    };
            ...
            arrow: {
                ...
                enabled: !0,
                fn: function(t, e) {
                    if (!m(t.instance.modifiers, "arrow", "keepTogether"))
                        return t;
                    var i = e.element;
                    if ("string" == typeof i) {
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(p, m) {
                    if (t(p.instance.modifiers, "inner"))
                        return p;
                    ...
                    return w.forEach(function(t, e) {
                        ...
                        v = p.placement.split("-")[0],
                        _ = I(v);
                        var i, n = p.offsets.popper, s = p.offsets.reference, o = P, r = "left" === v && o(n.right) > o(s.left) || "right" === v && o(n.left) < o(s.right) || "top" === v && o(n.bottom) > o(s.top) || "bottom" === v && o(n.top) < o(s.bottom), a = o(n.left) < o(g.left), l = o(n.right) > o(g.right), h = o(n.top) < o(g.top), c = o(n.bottom) > o(g.bottom), u = "left" === v && a || "right" === v && l || "top" === v && h || "bottom" === v && c, d = -1 !== ["top", "bottom"].indexOf(v), f = !!m.flipVariations && (d && "start" === y && a || d && "end" === y && l || !d && "start" === y && h || !d && "end" === y && c);
                        (r || u || f) && (p.flipped = !0,
                        (r || u) && (v = w[e + 1]),
                        f && (y = "end" === (i = y) ? "start" : "start" === i ? "end" : i),
                        p.placement = v + (y ? "-" + y : ""),
                        p.offsets.popper = U({}, p.offsets.popper, k(p.instance.popper, p.offsets.reference, p.placement)),
            ...
            hide: {
                ...
                enabled: !0,
                fn: function(t) {
                    if (!m(t.instance.modifiers, "hide", "preventOverflow"))
                        return t;
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var r, a, l = void 0 === o ? e.gpuAcceleration : o, h = S(b(t.instance.popper)), c = {
                        position: s.position
                    }, u = {
                        left: P(s.left),
                        top: P(s.top),
                        bottom: P(s.bottom),
                        right: P(s.right)
                    }, d = "bottom" === i ? "top" : "bottom", f = "right" === n ? "left" : "right", p = N("transform");
                    if (a = "bottom" == d ? -h.height + u.bottom : u.top,
                    r = "right" == f ? -h.width + u.right : u.left,
                    l && p)
                        c[p] = "translate3d(" + r + "px, " + a + "px, 0)",
                        c[d] = 0,
                        c[f] = 0,
                    ...
                    return t.attributes = U({}, v, t.attributes),
                    t.styles = U({}, c, t.styles),
                    t
                },
                gpuAcceleration: !0,
                x: "bottom",
    ...
    d)
      ...
      , c = (r(u, [{
        ...
        value: function() {
            ...
            s(document.readyState, ["interactive", "complete"]) ? this.start() : n(document, "DOMContentLoaded", this.start),
            this.finished = []
        }
    }, {
        key: "start",
        value: function() {
            ...
            this.disabled() || (n(this.config.scrollContainer || window, "scroll", this.scrollHandler),
            n(window, "resize", this.scrollHandler),
            this.interval = setInterval(this.scrollCallback, 50)),
            this.config.live && new l(function(t) {
        ...
        value: function(t) {
            ...
            1 === t.nodeType)
                for (var e = (t = t.parentNode || t).querySelectorAll("." + this.config.boxClass), i = 0; i < e.length; i++) {
                    var n = e[i];
                    s(n, this.all) || (this.boxes.push(n),
                    this.all.push(n),
        ...
        value: function(t) {
            ...
            this.config.resetAnimation && (n(t, "animationend", this.resetAnimation),
    ...
    function u() {
        ...
        this.wowEvent = function(t, e, i, n) {
            var s = !(arguments.length <= 1 || void 0 === e) && e
              ...
              , a = void 0;
            return null != document.createEvent ? (a = document.createEvent("CustomEvent")).initCustomEvent(t, s, o, r) : null != document.createEventObject ? (a = document.createEventObject()).eventType = t : a.eventName = t,
            a
