...
<header class="header header-transparent header-sticky">
    <nav class="navbar navbar-sticky navbar-expand-lg" style="background-color: #0f202c" id="primary-menu">
        <div class="container"> <a class="logo navbar-brand" href="index.html"><img class="logo logo-light" src="assets/images/logo/logosmk.png" alt="Ebookyo Logo" /></a>
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" data-scroll="scrollTo" href="#author">Mading</a></li>
                    <li class="nav-item"><a class="nav-link" data-scroll="scrollTo" href="#feature">Ebook</a></li>
                    <li class="nav-item"><a class="nav-link" data-scroll="scrollTo" href="#about">Kategori Ebook</a></li>
